          ...
          child: ClipPath(
            ...
            child: Stack(
              children: [
                ...
                Padding(
                  padding: AppStyle.padding_LR_16().copyWith(left: width < 1200 ? 0 : width*0.25, right:  width < 1200 ? 0 : width*0.25),
                  child: Center(
                    child: Column(
                          ...
                          child: Column(
                            children: [
                              KSText(
                                ...
                                style: KSTheme.of(context).style.ts35w600.copyWith(color: AppStyle.blackLite, height: 1.4,),
